...
public class AnswerController {
    ...
    public List<Map<String,Object>> formatJson(Title title2, String sid){
        ...
        for (Title title : all) {//题目对于的答案
            ...
            maps.add(map);
            List<Answer> all1 = answerService.getAnswerAll(title.getTitleID());
    ...
    public List<Map<String,Object>> formatJsons(String tid){
        ...
        List<Title> all = answerService.getAlls(Integer.parseInt(tid));
        ...
        for (Title title : all) {
            ...
            //打印子级
            List<Answer> allfid = answerService.getAnswerAll(title.getTitleID());
...
//        System.err.println("--------------------------------------------------我进来了-----------------------------------------------------------");
        ...
        Integer integer = answerService.addTitle(title);
    ...
    public String kq(String tid){
        Integer updatekq = answerService.updatekq(Integer.parseInt(tid));
        if(updatekq>0){
            return "1";
        }
        return "2";
    ...
    public String gb(String tid){
        Integer updategb = answerService.updategb(Integer.parseInt(tid));
        if(updategb>0){
            return "1";
        }
        return "2";
    ...
    public String deletetm(String tid, HttpServletResponse response){
        ...
        Integer deletetim = answerService.deletetim(Integer.parseInt(tid));
        if(deletetim>0){
            return "1";
        }
        return "2";
